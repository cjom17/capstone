...
<body>
	...
	<div class="main-container">
		...
		<form action="{{ route('update.section', ['section_id' => $section->id]) }}" method="post"  enctype="multipart/form-data">
						@csrf
						@method('PUT')
					<div class="form-group row">
						<label for="section_name" class="col-sm-2 col-form-label">Section Name</label>
						<div class="col-sm-10"> 
						<input type="text" class="form-control" name="section_name" id="section_name" placeholder="Enter the name of the section here..." value="{{ $section->section_name }}">
						</div>
					</div>
					<div class="form-group row">
						<label for="section_desc" class="col-sm-2 col-form-label">Section Description</label>
						<div class="col-sm-10">
						<textarea class="form-control" name="section_desc" id="section_desc" placeholder="Enter the section description here..."> {{ $section->section_desc }}</textarea>
						</div>
					</div>
