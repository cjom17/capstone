...
<body>
	...
	<div class="main-container">
		...
		<form action="{{ route('form.addForm') }}" method="POST" enctype="multipart/form-data">
    		@csrf
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="form_name" id="form_name" placeholder="Enter the name of the form here...">
					</div>
				</div>
				<div class="form-group row">
					<label for="form_desc" class="col-sm-2 col-form-label">Form Description: </label>
					<div class="col-sm-10">
						<textarea class="form-control" name="form_desc" id="form_desc" placeholder="Enter the form description here..."></textarea>
					</div>
				</div>
				<div class="form-group row">
