						...
						<div class="row">
							...
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									...
									<input type="text" id="position" name="position" class="form-control" placeholder="" value="{{ $admin->position }}"  >
								</div>
							</div>
							...
							<div class="col-md-6 col-sm-12">
								...
								<input type="date" id="date_of_birth" name="date_of_birth" class="form-control" value="{{ $admin->date_of_birth }}" >	
							</div>
