	...
	<div class="main-container">
		...
		<div class="mt-5">
            ...
            @endif
					...
					<form action="{{ route('update.teacher', ['teacher_id' => $teacher->id]) }}" method="post"  enctype="multipart/form-data">
						@csrf
						@method('PUT')
						...
						<div class="row">
							...
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									...
									<input type="text" id="position" name="position" class="form-control" placeholder="Teacher" value="{{ $teacher->position }}"  >
								</div>
							</div>
							
							<div class="col-md-4 col-sm-12">
								<label>ID number: </label>
								<input type="text" id="id_number" name="id_number" class="form-control" value="{{ $teacher->id_number }}" >	
							</div>
							...
							<div class="col-md-4 col-sm-12">
								...
								<input type="date" id="date_of_birth" name="date_of_birth" class="form-control" value="{{ $teacher->date_of_birth }}" >	
							</div>
							...
							<div class="col-md-6 col-sm-12">
								...
								<input type="text" id="phone_number" name="phone_number" class="form-control" value="{{ $teacher->phone_number }}" >	
								</div>
							</div>
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
								<label>Username: </label>
								<input type="text" id="username" name="username" class="form-control" value="{{ $teacher->username }}" >	
								</div>
							</div>
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
