			...
			<div class="card-box pd-20 height-100-p mb-30">
				<div class="row align-items-center">
					...
					<div class="col-md-8">
						...
						<p class="font-18 max-width-600">"Teachers plant the seeds of knowledge that last a lifetime. They cultivate minds, nurture curiosity, and inspire a love for learning. In the classroom, they are architects of a better future, shaping the world one student at a time."</p>
					</div>
				</div>
			</div>
