...
<div class="main-container">
		<div class="pd-ltr-20 xs-pd-20-10">
			...
			<form  action="{{route('updates.addUpdate')}}" method="POST"  enctype="multipart/form-data">
			@csrf
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
				<textarea class="form-control" name="update_desc" id="update_desc" placeholder="Enter the update description here..."></textarea>
				</div>
			</div>
			<div class="form-group row">
				<label for="event_date" class="col-sm-2 col-form-label">Update date</label>
				<div class="col-sm-10"> 
				<input type="date" class="form-control" name="update_date" id="update_date" placeholder="Select date">
				</div>
			</div>
