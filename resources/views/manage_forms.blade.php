						...
						<tr>
							...
							<td>
								<div class="dropdown">
									...
									<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
									<a class="dropdown-item" href="{{ route('updateForm.show', ['form_id' => $form->id]) }}"><i class="dw dw-edit"></i> Edit</a>
										<form action="{{ route('delete.form', ['id' => $form->id]) }}" method="post" onsubmit="return confirm('Are you sure you want to delete this form?')">
													@csrf
													@method('DELETE')
