...
<body>
	...
	<div class="main-container">
		<div class="pd-ltr-20 xs-pd-20-10">
			...
			<form  action="{{route('subjects.addsubject')}}" method="POST" >
				@csrf
					<div class="form-group row">
						<label for="subject_name" class="col-sm-2 col-form-label">Subject Name</label>
						<div class="col-sm-10"> 
						<input type="text" class="form-control" name="subject_name" id="subject_name" placeholder="Enter the subject title here">
						</div>
					</div>
					<div class="form-group row">
						<label for="subject_desc" class="col-sm-2 col-form-label">Subject Description</label>
						<div class="col-sm-10">
						<textarea class="form-control" name="subject_desc" id="subject_desc" placeholder="Enter the subject description here..."></textarea>
						</div>
					</div>
					<div class="form-group row">
