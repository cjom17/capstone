...
<html lang="en">
  ...
  <meta http-equiv="Content-Security-Policy" content="upgrade-insecure-requests">
  	...
  	<title>Login | Boljoon National High School</title>
    <meta charset="utf-8">
	...
	<section class="ftco-section">
		<div class="container" >
			...
			<div class="row justify-content-center">
				<div class="col-md-12 col-lg-10">
					<div class="wrap d-md-flex">
						<div class="img" style="background-image: url(images/teacher.png);">
			      </div>
			...
			<p class="text-center">Lost your account? <a data-toggle="tab" href="{{ route('teacher.password.request') }}" style="color: #11CC72;">Forgot Password</a></p>
		        </div>
		      </div>
				</div>
			</div>
