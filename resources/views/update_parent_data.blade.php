	...
	<div class="main-container">
		...
		<div class="mt-5">
            ...
            @endif
					...
					<form  action="{{ route('update.parent', ['parent_id' => $parent->id]) }}" method="post" enctype="multipart/form-data">
						@csrf
						@method('PUT')
						<div class="row">
							<div class="col-md-6">
							...
							<div class="col-md-6 col-sm-12">
								...
								<input type="text" id="student_lrn" name="student_lrn" class="form-control" value="{{ $parent->student_lrn }}" >	
							</div>

							<div class="col-md-3 col-sm-12">
								<label>First Name : </label>
								<input type="text" id="f_name" name="f_name" class="form-control" value="{{ $parent->f_name }}" >	
							</div>
							<div class="col-md-3 col-sm-12">
								<label>Last Name : </label>
								<input type="text" id="l_name" name="l_name" class="form-control" value="{{ $parent->l_name }}" >	
							</div>
							<div class="col-md-3 col-sm-12">
								<label>Middle Name : </label>
								<input type="text" id="m_name" name="m_name" class="form-control" value="{{ $parent->m_name }}" >	
							</div>
							<div class="col-md-3 col-sm-12">
								<label>Extension Name : </label>
								<input type="text" id="x_name" name="x_name" class="form-control" value="{{ $parent->x_name }}" >	
							</div>
							...
							<div class="col-md-3 col-sm-12">
								...
								<input type="text" id="nationality" name="nationality" class="form-control" value="{{ $parent->nationality }}" >	
							</div>
							<div class="col-md-3 col-sm-12">
								<label>Religion : </label>
								<input type="text" id="religion" name="religion" class="form-control" value="{{ $parent->religion }}" >	
							</div>
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									<label>Age : </label>
									<input type="text" id="age" name="age" class="form-control" value="{{ $parent->age }}" >	
								</div>
							</div>
							...
							<div class="col-md-4 col-sm-12">
								...
								<input type="text" id="phone_number" name="phone_number" class="form-control" value="{{ $parent->phone_number }}" >	
								</div>
							</div>
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
